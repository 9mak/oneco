"""四日市市 (city.yokkaichi.lg.jp) PDF 系 rule-based adapter

対象ドメイン: https://www.city.yokkaichi.lg.jp/

四日市市は保護動物情報を PDF で配布しており、一覧 HTML から
PDF リンクを抽出してダウンロード→pdfplumber でテキスト化→
ラベル付きフィールドを正規表現で抽出する。
...
class CityYokkaichiPdfAdapter(PdfTableAdapter):
    """四日市市 (保護動物情報) PDF 用 rule-based adapter"""
