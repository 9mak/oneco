...
10. 品種（breed）: 犬種・猫種名（柴犬、チワワ、トイプードル、雑種、ミックス等）をそのまま返す。ページに無ければ空文字
11. 性格・特徴（features）: 性格や特徴の記述（「人懐っこい」「シャイ」「甘えん坊」等）をそのまま返す。ページに無ければ空文字
12. 仮名・愛称（name）: 施設が付けた呼び名・愛称（「ポチ」等）をそのまま返す。ページに無ければ空文字
13. 管理番号（management_number）: 収容番号・個体管理番号（「R7-249」等）をそのまま返す。ページに無ければ空文字
    ...
    "function": {
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "breed": {
                    "type": "string",
                    "description": "品種・犬種猫種名（例: 柴犬, チワワ, 雑種）。無ければ空文字",
                },
                ...
                "features": {
                    "type": "string",
                    "description": "性格・特徴（例: 人懐っこい, シャイ）。無ければ空文字",
                },
                "name": {
                    "type": "string",
                    "description": "仮名・愛称（例: ポチ）。無ければ空文字",
                },
                "management_number": {
                    "type": "string",
                    "description": "収容番号・管理番号（例: R7-249）。無ければ空文字",
                },
            },
            "required": [
                "species",
