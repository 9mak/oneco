...
# (spec: config/site_specs/douai_pref_tochigi_stray.yaml)。
DouaiPrefTochigiStrayAdapter = SiteAdapterRegistry.get("栃木県動物愛護指導センター（迷子動物・犬）")
assert DouaiPrefTochigiStrayAdapter is not None
