...
from src.data_collector.infrastructure.database.models import AnimalStatusHistory, Base
from src.data_collector.infrastructure.database.repository import AnimalRepository
from src.data_collector.orchestration.collector_service import CollectorService
...
class TestE2EDataPersistenceFlow:
    ...
    @pytest.mark.asyncio
    async def test_save_and_retrieve_via_repository(self, repository, sample_animal_data_list):
    ...
    @pytest.mark.asyncio
    async def test_upsert_updates_existing_record(self, repository, sample_animal_data_list):
...
class TestE2EAPIFlow:
    ...
    @pytest.mark.asyncio
    async def test_e2e_save_and_get_via_api(self, repository, test_app, sample_animal_data_list):
    ...
    @pytest.mark.asyncio
    async def test_e2e_get_by_id_via_api(self, repository, test_app, sample_animal_data_list):
        ...
        async with AsyncClient(
            ...
            target_item = next(
                (item for item in items if item["source_url"] == str(saved_animal.source_url)), None
            )
    ...
    @pytest.mark.asyncio
    async def test_e2e_filter_via_api(self, repository, test_app, sample_animal_data_list):
    ...
    @pytest.mark.asyncio
    async def test_e2e_pagination_via_api(self, repository, test_app, sample_animal_data_list):
...
class TestE2ECollectorServiceFlow:
    ...
    def mock_diff_detector(self, sample_animal_data_list):
        ...
        detector.detect_diff.return_value = DiffResult(
            new=sample_animal_data_list, updated=[], deleted_candidates=[]
        )
        return detector
...
class TestE2EStatusManagementFlow:
    ...
    @pytest.mark.asyncio
    async def test_e2e_status_update_via_api(self, repository, test_app, sample_animal_data_list):
    ...
    @pytest.mark.asyncio
    async def test_e2e_status_filter_via_api(self, repository, test_app, sample_animal_data_list):
