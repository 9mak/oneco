...
async def test_animal_table_exists(async_engine):
    ...
    async with async_engine.connect() as conn:
        result = await conn.run_sync(lambda sync_conn: inspect(sync_conn).has_table("animals"))
...
async def test_animal_category_is_indexed(async_engine):
    ...
    async with async_engine.connect() as conn:
        ...
        indexes = await conn.run_sync(lambda sync_conn: inspect(sync_conn).get_indexes("animals"))
