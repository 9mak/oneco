...
- [x] 1. rule-based 共通基底クラスとサイト振り分け基盤を構築する
- [x] 1.1 (P) `RuleBasedAdapter` 共通基底を実装する
...
- [x] 1.2 (P) `WordPressListAdapter` 基底を実装する
...
- [x] 1.3 (P) `SinglePageTableAdapter` 基底を実装する
  ...
  - _Requirements: 1.1, 2.4_
- [x] 1.4 (P) `PlaywrightAdapter` 基底を実装する
  ...
  - _Requirements: 1.1, 2.4_
- [x] 1.5 (P) `PdfTableAdapter` 基底を実装する
  ...
  - _Requirements: 1.1, 2.4_
- [x] 1.6 `SiteAdapterRegistry` でサイト名と派生クラスを紐付ける機構を実装する
...
- [x] 2. エントリ振り分けと運用追跡を整備する
- [x] 2.1 `sites.yaml` スキーマを拡張する
...
- [x] 2.2 `run_rule_based_sites` 関数を `__main__.py` に追加する
...
- [x] 3. テスト基盤と各種別 Top 5 サイト分のアダプターを実装する
- [x] 3.1 HTML スナップショットテストの基盤を整備する
...
- [x] 3.2 (P) standard 種別 Top 5 サイトのアダプターを実装する
...
- [x] 3.3 (P) single_page 種別 Top 5 サイトのアダプターを実装する
  ...
  - _Requirements: 2.1, 2.2, 2.3, 5.1, 5.2, 9.5_
- [x] 3.4 (P) requires_js 種別 Top 5 サイトのアダプターを実装する
  ...
  - _Requirements: 2.1, 2.2, 2.3, 5.1, 5.2, 9.5_
- [x] 3.5 (P) pdf 種別 Top 3 サイトのアダプターを実装する
...
- [x] 4. 中ボリュームと長尾サイトのアダプターを実装する
- [x] 4.1 (P) Top 11-30 ランク（中ボリューム）のテンプレートを実装する
  ...
  - _Requirements: 2.1, 2.2, 2.3, 5.1, 5.2, 9.5_
- [x] 4.2 (P) Top 31-60 ランク（中尾）のテンプレートを実装する
...
- [x] 6.1 `default_provider` を `rule-based` に切替える最終 PR を発行する
